...
The file you want is named something like `retromod-1.0.0-beta.10.jar`. Download it somewhere you'll remember — your Downloads folder is fine.
...
3. Drop `retromod-1.0.0-beta.10.jar` into `mods/`.
4. Launch Minecraft.

That's it. On macOS, the command-line version of step 3 looks like:

```bash
cp ~/Downloads/retromod-1.0.0-beta.10.jar \
