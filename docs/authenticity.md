...
- **Manually with `jarsigner`:** run `jarsigner -verify -verbose -certs retromod-1.0.0-beta.6.jar` in a terminal. Java's built-in verifier will print the cert and whether the contents are intact.
