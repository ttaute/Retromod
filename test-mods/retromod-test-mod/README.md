...
- [x] **v0.2.1**: Three lifecycle phases (`init` / `client-started` / `world-join`), 250 tests. Currently 250/252 passing. The only known failures are Test 5 (`getString()` toString format) and Test 14 (SOUND_EVENT descriptor mismatch, documented).
