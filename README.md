...
- **Status**: **1.2.0-rc.2** is the current pre-release (Forge 26.2 hosts, worldgen on 26.x). Keep backups of your mod JARs.
...
1. Put `retromod-1.2.0-rc.2+<your-mc>.jar` in `mods/`.
