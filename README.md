...
1. Download `retromod-1.0.0-beta.6.jar` and put it in `mods/`
...
- **Old MC version support** isn't a separate branch — the shims for 1.12.2, 1.14.4, 1.16.5, etc. all compile into the same `retromod-1.0.0-beta.6.jar`. Drop in a 1.16.5 mod, Retromod walks it through the chain. (See `src/main/java/com/retromod/shim/` — every version transition is a file in there.)
