...
Output JAR: `target/retromod-<version>.jar` (current: `retromod-1.2.0-rc.2.jar`)
...
python3 scripts/compute-self-hash.py target/retromod-1.2.0-rc.2-all.jar
...
```bash
cp target/retromod-1.2.0-rc.2.jar ~/Library/Application\ Support/minecraft/mods/retromod-1.2.0-rc.2+26.1.jar
```
