...
Output JAR: `target/retromod-<version>.jar` (current: `retromod-1.3.0-snapshot.1.jar`)
...
python3 scripts/compute-self-hash.py target/retromod-1.3.0-snapshot.1-all.jar
...
```bash
cp target/retromod-1.3.0-snapshot.1.jar ~/Library/Application\ Support/minecraft/mods/retromod-1.3.0-snapshot.1+26.1.jar
```
