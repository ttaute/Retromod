...
Output JAR: `target/retromod-1.0.0-beta.6.jar`

## Deploy to Minecraft

```bash
cp target/retromod-1.0.0-beta.6.jar ~/Library/Application\ Support/minecraft/mods/retromod-1.0.0-beta.6+26.1.jar
```
